...
export default function PageHero({data}:{data:TPageHeroProps}) {
  ...
  return (
    <section className="bg-gradient-to-r from-teal-100 to-orange-100 border-[1px] border-orange-100 md:px-[5rem] px-[2rem] py-[2.5rem] space-y-[1.5rem] relative" data-html2canvas-ignore>
