    ...
    <div>
      ...
      <div className="flex justify-between items-center text-[1rem] mb-1">
        <label
          ...
          htmlFor="property"
        >
          <span>Personal & Other Loans</span>{" "}
          <Icon
        ...
        >
          <span>Add Personal & Other Loans</span>
          {showSubInputs ? (
      ...
      <input
        ...
        onChange={(e) =>
          dispatch(setPersonalOtherLoans(Number(e.target.value)))
        }
      />
        ...
        <div className="mt-3 text-[14px] flex gap-[1.5rem] overflow-x-auto pb-2">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(setPersonalLoan(Number(e.target.value)))
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => dispatch(setStudentLoan(Number(e.target.value)))}
            />
          </div>
