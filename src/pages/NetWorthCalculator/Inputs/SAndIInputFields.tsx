  ...
  return (
    <div>
      ...
      <input
        ...
        onChange={(e) => dispatch(setSavingsInvestment(Number(e.target.value)))}
      />
        ...
        <div className="mt-3 text-[14px] flex gap-[1.5rem] overflow-x-auto pb-2">
          <div>
            ...
            <input
              ...
              onChange={(e) => dispatch(setRRSP(Number(e.target.value)))}
            />
          </div>
          <div>
            <label
            ...
            <input
              ...
              onChange={(e) => dispatch(setRRIF(Number(e.target.value)))}
            />
          </div>
          <div>
            <label
            ...
            <input
              ...
              onChange={(e) => dispatch(setRESP(Number(e.target.value)))}
            />
          </div>
