    ...
    <div>
      ...
      <div className="flex justify-between items-center text-[1rem] mb-1">
        ...
        >
          ...
          <CustomTooltip title="Savings account balance, checking account balance, retirement accounts (401(k), IRA, etc.), stocks, bonds, mutual funds and other investment accounts (e.g., real estate investment trust)." />
        </label>
