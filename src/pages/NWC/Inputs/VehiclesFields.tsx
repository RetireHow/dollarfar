    ...
    <div>
      ...
      <DisplayTotal
        data={{
          ...
          total: vehiclesTotal,
          fieldTitle: "Vehicles",
          buttonText: "Add Vehicles",
          infoText:
            "Value of car(s) and value of other vehicles (motorcycle, Tractor, etc.). Enter depreciated/present market value here.",
        }}
      />
      ...
      {showSubInputs && (
        <div className="mt-3 text-[14px] flex flex-col gap-[0.5rem] overflow-x-auto pb-2">
          ...
          <div>
            ...
            >
              <span className="text-[1.3rem] pr-1">+</span> Add More Vehicles
            </button>
          </div>
        </div>
      )}
