    ...
    <main>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-900">
        <div className="max-w-6xl mx-auto px-6 py-10">
          ...
          <section className="bg-gradient-to-r from-teal-50 to-orange-50 rounded-xl shadow-sm p-6">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                {results && (
                  <div className="border-l-4 border-teal-600 bg-teal-50 p-4 rounded mb-4 text-sm leading-6">
