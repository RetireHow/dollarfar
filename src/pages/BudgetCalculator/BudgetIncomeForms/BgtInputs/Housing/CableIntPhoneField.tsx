      ...
      <div>
        <div className="flex justify-between items-center text-[1rem] mb-1 overflow-x-auto">
          <label
            ...
            htmlFor="property"
          >
            <span className="text-nowrap">Cable Tv / Internet / Home Phone / Cell Phone </span>{" "}
            <CustomTooltip title="Combined cost of cable TV, internet, home phone, and cell phone services." />
          </label>
