...
import PollutionSkeletonLoader from "../SkeletonLoaders/PollutionSkeletonLoader";
...
function PollutionDynamicComponent({
  ...
  if (isLoading) {
    return <PollutionSkeletonLoader />;
  }
  return (
    <div>
      <div>
        <div className="border-[1px] bg-[#FBFBF8] dark:bg-darkModeBgColor dark:text-darkModeNormalTextColor border-gray-300 p-3 mb-[1rem] mt-[1rem] rounded-lg w-full">
          <div className="mb-2 text-[1rem]">
            <h3 className="font-bold text-[1.5rem]">{city}</h3>
      ...
      <div className="space-y-[1rem] mt-[3rem]">
        ...
        <div className="overflow-x-auto">
          <table className="border-collapse bg-[#FBFBF8] dark:bg-darkModeBgColor dark:text-darkModeNormalTextColor w-full">
            <tbody>
              {air_quality ? (
                <tr>
                  ...
                  <td className="border p-2 min-w-[50px]">
                    <Progress
                      percent={Number(calculateIndex(air_quality)?.toFixed(2))}
                      showInfo={false}
                      strokeColor="#4682b4"
                      strokeLinecap="butt"
                      size={{ height: 20 }}
              ...
              {garbage_disposal_satisfaction ? (
                <tr>
                  ...
                  <td className="border p-2">
                    {calculateIndex(garbage_disposal_satisfaction)?.toFixed(2)}
                  </td>
                  <td
                    style={{
                      color: getColorForIndex(
                    ...
                    className="border p-2"
                  >
                    {getRating(calculateIndex(garbage_disposal_satisfaction))}
                  </td>
                </tr>
              ) : (
                ""
              ...
              {clean_and_tidy ? (
                <tr>
                  ...
                  <td
                    style={{
                      color: getColorForIndex(calculateIndex(clean_and_tidy)),
                    }}
                    className="border p-2"
                  >
              ...
              {noise_and_light_pollution ? (
                <tr>
                  ...
                  <td className="border p-2">
                    {calculateIndex(noise_and_light_pollution, false)?.toFixed(
                      2
                    )}
                  </td>
                  <td
        ...
        <div className="overflow-x-auto">
          <table className="border-collapse bg-[#FBFBF8] dark:bg-darkModeBgColor dark:text-darkModeNormalTextColor w-full">
            <tbody>
              ...
              {garbage_disposal_satisfaction ? (
                <tr>
                  <td className="border p-2">Garbage Disposal Satisfaction</td>
                  <td className="border p-2">
                    <Progress
                      percent={Number(
                        calculateIndex(
              ...
              {water_pollution ? (
                <tr>
                  ...
                  <td
                    style={{
                      color: getColorForIndex(calculateIndex(water_pollution)),
                    }}
                    className="border p-2"
                  >
              ...
              {comfortable_to_spend_time ? (
                <tr>
                  ...
                  <td className="border p-2">
                    {calculateIndex(comfortable_to_spend_time, false)?.toFixed(
                      2
                    )}
                  </td>
                  <td
              ...
              {green_and_parks_quality ? (
                <tr>
                  ...
                  <td className="border p-2">
                    <Progress
                      percent={Number(
                        calculateIndex(green_and_parks_quality, false)?.toFixed(
                          2
                        )
                      )}
                      showInfo={false}
                  ...
                  <td className="border p-2">
                    {calculateIndex(green_and_parks_quality, false)?.toFixed(2)}
                  </td>
                  <td
                    style={{
                      color: getColorForIndex(
                    ...
                    className="border p-2"
                  >
                    {getRating(calculateIndex(green_and_parks_quality, false))}
                  </td>
                </tr>
              ) : (
                ""
  ...
  return (
    <main className="md:m-10 m-3">
      <h3 className="md:text-[1.5rem] font-semibold mb-[2rem] dark:text-darkModeHeadingTextColor">
        Pollution comparison between {selectedCityName2} and {selectedCityName1}
      </h3>
