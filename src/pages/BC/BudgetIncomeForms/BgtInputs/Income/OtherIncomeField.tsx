    ...
    <div>
      ...
      <BCTotalDisplay
        data={{
          showSubInputs,
          setShowSubInputs,
          total: otherIncome as number,
          buttonText: "Add Other Income",
          fieldTitle: "Other Income",
          infoText:
            "Add any additional income sources, like rental income, investments, dividends, or occasional earnings.",
        }}
      />
