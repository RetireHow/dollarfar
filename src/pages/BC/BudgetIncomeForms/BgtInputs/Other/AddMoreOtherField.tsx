...
export const AddMoreOtherField = () => {
    ...
    <div>
      ...
      <div className="text-[1rem] gap-[1.5rem] overflow-x-auto pb-2">
        ...
        {dynamicInputs.map((input) => (
          <div key={input.id} className="mb-[2rem] mt-[1rem]">
            ...
            <input
              ...
              onChange={(e) => handleDynamicInputChange(e, input.id, 'other')}
            ...
            <div className="flex items-center justify-between gap-4 w-full">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  onClick={()=>handleSaveInput({category:'other'})}
                >
                  Save
                </button>
        ...
        <div>
          ...
          >
            <span className="text-[1.3rem] pr-1">+</span> Add More Other
            Expenses
          </button>
        </div>
      </div>
